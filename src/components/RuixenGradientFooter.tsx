...
export function RuixenGradientFooter({
  ...
  useEffect(() => {
    ...
    // A raw scroll listener can fire many times per animation frame —
    // each call was triggering a React re-render via setProgress, so
    // this coalesces bursts down to at most one measure (and one
    // re-render) per frame instead.
