...
const UNIFORMS = {
  // Dark navy palette matched to the site's own near-black background
  // (rgb(6,6,9), see --bg in index.css) instead of the original red/cream
  // recipe: near-black -> deep navy -> mid slate-blue -> softer blue
  // highlight. The highlight was originally near-white (0.59/0.75/1) and
  // washed out badly wherever the noise pattern landed on it, wrecking
  // contrast for text sitting on top — kept it a mid blue instead so no
  // area of the field ever gets bright enough to compete with light text.
  colors: [[0.023529411764705882,0.023529411764705882,0.047058823529411764],[0.06274509803921569,0.12549019607843137,0.2901960784313726],[0.1411764705882353,0.29019607843137253,0.6196078431372549],[0.23529411764705882,0.37254901960784315,0.6666666666666666],[0.23529411764705882,0.37254901960784315,0.6666666666666666],[0.23529411764705882,0.37254901960784315,0.6666666666666666],[0.23529411764705882,0.37254901960784315,0.6666666666666666],[0.23529411764705882,0.37254901960784315,0.6666666666666666]] as [number, number, number][],
  colorCount: 4,
  scale: 1.500,
  intensity: 0.550,
  paramA: 0.500,
