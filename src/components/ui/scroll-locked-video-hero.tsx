...
export default function MusicHero({
  ...
  function handlePlayerKeyDown(e: ReactKeyboardEvent<HTMLDivElement>) {
...
function SeamlessLoopVideo({
  ...
  const base: CSSProperties = { position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }
  return (
    <>
